...
class ErrorObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets type
     *
     * @param string $type Stable machine-readable error category (snake_case). Aligns with docs/interfaces/rest_api_spec.md (e.g. validation_error, auth_error).
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param array<string,mixed>|null $details Optional structured context (field hints, provider payloads, etc.).
     *
     * @return self
     */
