...
| 観点 | 細分化の効果 |
|------|----------------|
| **AI 伴走開発** | タスクごとに参照すべきドキュメントが明確になり、プロンプトに「このファイルだけ読め」と指定しやすい。変更影響範囲も把握しやすい。 |
...
次の種類ごとに **1 ファイル 1 関心** にすると、AI も人間も参照しやすくなります。
...
- **1 ファイルは「ひとりの担当者が 1 テーマで完結して読める長さ」**（目安: 100〜300 行程度。複雑な数式や表が多い場合はもう少し長くても可）
